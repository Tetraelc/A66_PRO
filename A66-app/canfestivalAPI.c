...
S_Data_trans Adjust_ManualDate    = {0x05,0x6060,0x00,0x01,0x06,
...
S_Data_trans SystemSet_Motor[3]        = { {0x03, 0x607B,0x01,0x04,0xAA,// 最小限位
                                              0x607B,0x02,0x04,0xAA,// 最大限位
                                              0x6093,0x01,0x04,0x0a,},
                                        {0x03, 0x607B,0x01,0x04,0xAA,// 最小限位
                                              0x607B,0x02,0x04,0xAA,// 最大限位
                                              0x6093,0x01,0x04,0x0a,},
                                        {0x03, 0x607B,0x01,0x04,0xAA,// 最小限位
                                               0x607B,0x02,0x04,0xAA,// 最大限位
